...
- JOURNALISM GUARDRAIL: Every numeric claim, dollar figure, percentage, date, name, and place mentioned in the VO must appear in the article body. Do NOT invent statistics, round numbers up, or generalize specifics. If the article says "327,000 outdoor workers," VO may say "three hundred and twenty-seven thousand outdoor workers" but not "hundreds of thousands of outdoor workers" and not "half a million outdoor workers." Editorial compression of arguments is encouraged; invented facts are forbidden.
